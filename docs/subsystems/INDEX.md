...
| [`pairing.md`](./pairing.md) | `src/pairing.js` | The X25519 + SAS handshake; a **contested pairing is a fatal, non-recoverable abort** by design (recoverability deliberately deferred, not rejected). |
